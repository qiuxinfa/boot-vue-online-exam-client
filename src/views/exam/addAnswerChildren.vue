    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        <ul>
          <li>
            <span>题目类型:</span>
            <el-select v-model="optionValue" placeholder="请单择题型" class="w150">
              <el-option
        ...
        <!-- 单择题部分 -->
        <div class="change" v-if="optionValue == '单择题'">
          <div class="title">
    ...
    <el-tab-pane name="second">
      ...
      <div class="box">
        <ul>
          ...
          <li>
            <span>单择题数量：</span> <el-input type="text" v-model="changeNumber"></el-input>
          </li>
          <li>
...
export default {
  data() {
    return {
      changeNumber: null, //单择题出题数量
      multiNumber: null, //多择题出题数量
      ...
      postPaper: { //考试管理表对应字段
        paperId: null,
        questionType: null, // 试卷类型 1--单择题  2--填空题   3--判断题
        questionId: null,
      }
    };
  },
  ...
  methods: {
    ...
    changeSubmit() { //单择题题库提交
      this.postChange.subject = this.subject
      this.$axios({ //提交数据到单择题题库表
