            ...
            <div v-if="currentType == 2">
             ...
             <div v-if="currentType == 3">
               <el-checkbox-group v-model="multi[index]" @change="changeMulti" >
                 <el-checkbox :label="1">A: {{showAnswer.choiceA}}</el-checkbox>
                 <el-checkbox :label="2">B: {{showAnswer.choiceB}}</el-checkbox>
                 <el-checkbox :label="3">C: {{showAnswer.choiceC}}</el-checkbox>
                 <el-checkbox :label="4">D: {{showAnswer.choiceD}}</el-checkbox>
               </el-checkbox-group>
               <div class="analysis" v-if="isPractice">
                 <ul>
                   <li> <el-tag type="success">正确姿势：</el-tag><span class="right">{{reduceAnswer.rightAnswer}}</span></li>
